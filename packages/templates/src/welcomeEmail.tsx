                    ...
                    <Container className="w-full max-w-[600px] mx-auto p-5">
                        <Section className="p-[50px_30px] bg-white rounded-[20px] text-center shadow-md">
                            ...
                            <Text className="text-lg mt-4">
                                Welcome to Shega Jobs! We're thrilled to have
                                you join our community as a {role}.
                            </Text>
                            <Text className="text-lg mt-4">
                                Your account has been successfully created.
                            </Text>
                            <Text className="text-lg mt-4 font-semibold">
                                To get started, log in using the following
                                credentials:
                            </Text>
                            <Text className="mt-2">
                            ...
                            <Text className="mt-2">
                                <strong>Password:</strong> Your temporary
                                password is:{' '}
                                <span className="font-bold">
                                    {temporaryPassword}
                                </span>
                                . You need to change it after logging in.
                            </Text>
                        </Section>
