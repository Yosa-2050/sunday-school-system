...
import type { StringRequestModel } from '@shega/Utilities/models/list-string.model';
...
import type { SendStudentNotificationDto } from '../dto/request/send-notification-student.request.dto';
// biome-ignore lint/style/useImportType: <explanation>
