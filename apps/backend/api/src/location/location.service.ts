...
export class LocationService{
    ...
    constructor(@InjectRepository(Country) private readonly coutryRepo: Repository<Country>,
    @InjectRepository(LocationInfo) private readonly locationInfoRepo: Repository<LocationInfo>){}
