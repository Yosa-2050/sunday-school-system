  ...
  const editor = useEditor({
    extensions: [
      ...
      Table.configure({
        ...
        HTMLAttributes: {
          class:
            "w-[500px] h-[200px] border border-gray-200 border-black mb-4 focus:outline-hidden focus:ring-2 focus:ring-blue-500",
        },
      }),
      TableRow.configure({
        HTMLAttributes: {
  ...
  return (
    ...
    >
      <RichTextEditor editor={editor} style={{ height: "400px" }}>
        <RichTextEditor.Toolbar sticky stickyOffset={60} className="bg-white">
          {isMobile ? (
