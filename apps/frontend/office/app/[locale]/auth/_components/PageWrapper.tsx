  ...
  return (
    <Flex className="min-h-screen bg-primary-1 w-full">
      ...
      <Box className="relative h-screen bg-primary-1 md:w-1/2">
        <Carousel withIndicators height="100%" className="absolute inset-0 w-full h-full" loop>
          <Carousel.Slide>
            <Image
      ...
      <Flex direction="column" align="center" justify="center" className="w-full md:w-1/2 relative bg-gray-100 overflow-hidden" h={'100vh'}>
       <Link href="/">
        <Image
          src={Logo.src}
          alt="Logo"
        ...
        <Text size="sm" color="gray" className="absolute bottom-4 text-center">
          © {new Date().getFullYear()} All rights reserved by Shega Jobs
        </Text>
      </Flex>
    </Flex>
  );
