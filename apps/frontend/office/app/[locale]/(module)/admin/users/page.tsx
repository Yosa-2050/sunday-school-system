...
import { activateUser, deactivateUser } from "app/[locale]/_api/users/userStatus";
    ...
    ? [
        ...
        },
        {
          ...
          filters: filters.status
            ? [
                {
                  label: t(`status.${filters.status.toLowerCase()}`),
                ...
                rightSection={
                  <IconX
                    ...
                    onClick={() => {
                      if (group.type === "Role") {
                        handleRoleSelect(
                          filters?.roles.filter((r) => r !== filter.value) || []
                        );
          ...
          >
            ...
            <Group mt="xl" justify="flex-end">
              ...
              <Button
                ...
                onClick={async () => {
                  if (selectedUser) {
                    await handleStatus(selectedUser.id, true);
                    close();
                    setSelectedUser(null);
                  }
                }}
          ...
          >
            ...
            <Group mt="xl" justify="flex-end">
              ...
              <Button
                ...
                onClick={async () => {
                  if (selectedUser) {
                    await handleStatus(selectedUser.id, false);
                    activationHandlers.close();
                    setSelectedUser(null);
                  }
                }}
