      ...
      <div className="mb-4">
        <div className="bg-white p-6 rounded-lg shadow-sm">
          <Flex>
            ...
            <Text className="text-2xl font-semibold mb-2">{job.title}</Text>
          </Flex>
          <div className="flex items-center space-x-4 text-gray-600">
            ...
            <Badge variant="light">{job.type.replace("_", " ")}</Badge>
          </div>
        </div>
      </div>
        ...
        <Grid.Col span={{ base: 12, md: 3 }}>
          <Card shadow="sm" padding="lg" radius="md" withBorder>
            <Stack align="center" gap="sm">
              ...
              <Badge variant="light">{job.organization.name}</Badge>
              ...
              <Stack gap="xs" w="100%">
                ...
                <Group gap="sm">
                  ...
                  <Text size="sm">
                    {job.postedBy.employee.profile.phoneNumber || "N/A"}
                  </Text>
                </Group>
              </Stack>
            </Stack>
            ...
            <Stack>
              ...
              <Grid gutter="xl">
                <Grid.Col span={{ base: 12, md: 6 }}>
                  <Stack gap="sm">
                    ...
                    <Group gap="sm">
                      ...
                      <Text className="font-medium">Employment Type:</Text>
                    ...
                    {job.workPlace && (
                      <Group gap="sm">
                        ...
                        <Text className="font-medium">Workplace Type:</Text>
                        <Badge color="blue" variant="light">
                          {job.workPlace.replace("_", " ")}
                        </Badge>
                      </Group>
                    )}
                  </Stack>
                ...
                <Grid.Col span={{ base: 12, md: 6 }}>
                  <Stack gap="sm">
                    <Group gap="sm">
                      <IconCash size={20} className="text-gray-500" />
                      <Text className="font-medium">Salary Range:</Text>
                      <Text>
                    ...
                    <Group gap="sm">
                      ...
                      <Text>{job.educationalRequirment.replace("_", " ")}</Text>
                    </Group>
                    <Group gap="sm">
                      <IconCash size={20} className="text-gray-500" />
