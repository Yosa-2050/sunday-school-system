...
const updateProfile = (data: Partial<ProfileResponse>, id: string) => {
...
const useUpdateProfile = (id: string) => {
    ...
    return useMutation({
        mutationFn: (data: Partial<ProfileResponse>) => updateProfile(data, id),
        onSuccess: () => {
...
export default function PersonalInfoSection({
    ...
    const onSubmit = (formData: Partial<ProfileResponse>) => {
