  ...
  return (
    <PageContainer>
      <Group mb="xs" gap="xs" align="center">
        ...
        />
        <Text fw={700} size="lg">Program Detail</Text>
      </Group>
      <Divider />
      ...
      <Paper shadow="xs" p="md" mt="lg" radius="md">
        <Tabs defaultValue="calendarYears">
          <Tabs.List>
            <Tabs.Tab value="calendarYears">Calendar Years</Tabs.Tab>
                ...
                <Table.Tbody>
                  {years.map((year: any) => (
                    <Table.Tr key={year.id}>
                      ...
                      <Table.Td>
                        <Badge color={year.isActive ? "green" : "red"}>
                          {year.isActive ? "Active" : "Inactive"}
                        </Badge>
                      </Table.Td>
                      <Table.Td>{year.createdBy}</Table.Td>
                      <Table.Td>
