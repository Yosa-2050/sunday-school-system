    ...
    <Paper shadow="sm" p="xl" radius="md" withBorder>
      <Stack gap="xl">
        ...
        <Grid>
          ...
          <Grid.Col span={{ base: 12, sm: 6 }}>
            <Group gap="xs" mb="md">
              <IconCurrencyDollar size={20} className="text-gray-500" />
              <Text size="sm" c="dimmed">
                {formatSalary(
                  formData.salaryFrom,
                  formData.salaryTo,
        ...
        <div>
          ...
          <Grid>
            <Grid.Col span={{ base: 12, sm: 6 }}>
              <Group gap="xs" mb="md">
                <IconBriefcase size={20} className="text-gray-500" />
                <Text size="sm" c="dimmed">
                  {formData.experianceLevel} Level • {formData.experiance} years
                  experience
                </Text>
              </Group>
            </Grid.Col>
            ...
            <Grid.Col span={{ base: 12, sm: 6 }}>
              <Group gap="xs" mb="md">
                <IconCapRounded size={20} className="text-gray-500" />
                <Text size="sm" c="dimmed">
