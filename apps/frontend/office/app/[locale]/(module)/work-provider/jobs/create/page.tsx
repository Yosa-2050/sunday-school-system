...
import { Container, Stepper, Title, Button, Group, Paper } from "@mantine/core";
  ...
  return (
    <FormProvider {...methods}>
      ...
      >
        ...
        >
          <Stepper.Step label="Job Details" description="Basic job information">
            <JobDetails
          ...
          <Stepper.Step label="Salary" description="Salary and compensation">
            <SalaryAndCompensation
              salaryFrequencyTypes={salaryFrequencyTypes}
            />
          </Stepper.Step>

          <Stepper.Step label="Requirements" description="Job requirements">
            <JobRequirements
          ...
          <Stepper.Step label="Application" description="Application details">
