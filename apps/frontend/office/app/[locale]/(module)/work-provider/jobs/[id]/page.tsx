        ...
        >
          ...
          >
            ...
            <Text
              ...
              dangerouslySetInnerHTML={{ __html: firstLineOfDescription ?? "" }}
            />
          </Alert>

          <Text size="lg" fw={600} mb="sm" style={{ color: "#2d3748" }}>
          ...
          <Stack gap="sm">
            <Title
              order={3}
              style={{ color: "#1a202c", fontSize: "1.25rem", fontWeight: 600 }}
            >
              Job Description
            </Title>
            <Group gap="xs">
              <Text fw={500} style={{ color: "#2d3748", minWidth: "200px" }}>
                Job Title:
              </Text>
              <Text style={{ color: "#4a5568" }}>{job.title}</Text>
            </Group>
            <Group gap="xs">
              <Text fw={500} style={{ color: "#2d3748", minWidth: "200px" }}>
                Job Type:
            ...
            <Group gap="xs" align="flex-start">
              ...
              <Stack gap={0}>
                <Text style={{ color: "#4a5568" }}>- React</Text>
                <Text style={{ color: "#4a5568" }}>- Laravel</Text>
                <Text style={{ color: "#4a5568" }}>- Python</Text>
              </Stack>
            </Group>
          </Stack>
          ...
          <Text
            style={{ lineHeight: 1.6, color: "#4a5568", fontSize: "0.95rem" }}
          >
