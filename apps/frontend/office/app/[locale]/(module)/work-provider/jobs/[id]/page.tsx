          ...
          <Group justify="space-between" align="flex-start">
            <Group gap="lg" wrap="nowrap">
              <Avatar size={64} radius="md">
                <IconBuilding size={32} style={{ color: "primary" }} />
              </Avatar>
              <div>
            ...
            <Stack gap="sm">
              <Badge
                size="lg"
                color={jobData.status === "Active" ? "teal" : "orange"}
              >
                {jobData.status}
              </Badge>
              <Group gap="xs">
          ...
          <Stack gap="xl">
            ...
            <Card withBorder radius="md">
              <Card.Section withBorder p="md" bg="gray.0">
                ...
                <Text c="gray.6">
                  Track your applicants through the hiring process
                </Text>
              </Card.Section>
              <Box p="xl">
                <Stack gap="xl">
                    ...
                    <Group justify="space-between">
                      <Group>
                        ...
                        <div>
                          ...
                          <Title order={3}>{jobData.stats.applicants}</Title>
                        </div>
                      </Group>
                      <Group>
                        <Button
                        ...
                        <Button leftSection={<IconEye size={14} />}>
                          View All
                        </Button>
                      </Group>
                    </Group>
                  ...
                  <SimpleGrid cols={{ base: 1, md: 4 }}>
                    ...
                    <Paper withBorder p="md" radius="md" bg="gray.0">
                      ...
                      <Progress
                        value={
                          (jobData.stats.hired / jobData.stats.applicants) * 100
                        }
                        size="sm"
                      />
                    </Paper>
                  ...
                  <SimpleGrid cols={{ base: 1, md: 3 }}>
                    <Paper
                      ...
                      radius="md"
                      bg="teal.0"
                      style={{ borderColor: theme.colors.teal[2] }}
                    >
                      <Group wrap="nowrap">
                        <IconCircleCheck
                          size={40}
                    ...
                    >
                      <Group wrap="nowrap">
                        <IconX size={40} color={theme.colors.red[5]} />
                        <div>
            ...
            <Card withBorder radius="md">
              <Card.Section withBorder p="md" bg="gray.0">
                <Group justify="space-between">
                  <Group>
                    <IconUsers size={20} color={theme.colors.gray[6]} />
                    <Title order={2}>Recent Applicants</Title>
                  </Group>
                  <Button variant="outline">View All</Button>
                </Group>
                <Text c="gray.6">
                  Latest candidates who applied for this position
                </Text>
              </Card.Section>
              <Card.Section>
                {[1, 2, 3].map((i) => (
                  ...
                  >
                    <Group justify="space-between">
                      <Group>
                        <Avatar>{String.fromCharCode(64 + i)}</Avatar>
                        <div>
                          <Text fw={500}>Candidate {i}</Text>
                          <Text size="sm" c="dimmed">
                            Applied 2 day{i > 1 ? "s" : ""} ago
                          </Text>
                        </div>
                      </Group>
                      <Group gap={4}>
          ...
          <Stack gap="xl">
            ...
            <Card withBorder radius="md">
              <Card.Section withBorder p="md" bg="primary.9">
                ...
                <Text c="gray.4">This job posting is currently active</Text>
              </Card.Section>
                ...
                <Stack gap="lg">
                  <Group justify="space-between">
                    <Group gap="xs">
                      ...
                      <Text size="sm">Posted {jobData.postedDate}</Text>
                    </Group>
                    <Badge variant="filled" color="gray">
                      {job?.deadline
            ...
            <Card withBorder radius="md">
              <Card.Section withBorder p="md" bg="gray.0">
                <Group>
                  <IconChartBar size={20} color={theme.colors.gray[6]} />
              ...
              <Card.Section p="xl">
                <Stack gap="lg">
                  <Paper withBorder p="md" radius="md">
                    <Group justify="space-between">
                      <Group gap="xs">
                        <IconEye size={20} color={theme.colors.gray[6]} />
                        <Text size="sm" fw={500}>
                          Total Views
                        </Text>
                      </Group>
                  ...
                  <Paper withBorder p="md" radius="md">
                    <Group justify="space-between">
                      ...
                      <Title order={3}>{jobData.stats.daysRemaining}</Title>
                    </Group>
                  </Paper>
                  <Divider />
                  <div>
                    <Group justify="space-between" mb="xs">
                      ...
                      <Text size="sm" c="gray.6" fw={500}>
                        {(
                          (jobData.stats.applicants / jobData.stats.views) *
                          100
                        ).toFixed(1)}
                        %
                      </Text>
                    ...
                    <Progress
                      value={
                        (jobData.stats.applicants / jobData.stats.views) * 100
                      }
                      size="sm"
                      mb="xs"
                    />
                    <Group justify="space-between">
                      <Text size="xs" c="gray.6">
                        {jobData.stats.applicants} applications
                      </Text>
                      <Text size="xs" c="gray.6">
                        {jobData.stats.views.toLocaleString()} views
                      </Text>
                    </Group>
                  </div>
                </Stack>
            ...
            <Card withBorder radius="md">
              <Card.Section withBorder p="md" bg="gray.0">
                <Group>
                  <IconExternalLink size={20} color={theme.colors.gray[6]} />
