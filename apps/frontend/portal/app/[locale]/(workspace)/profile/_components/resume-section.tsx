    ...
    <>
      <Card shadow="sm" withBorder>
        <Stack gap="md">
          ...
          {jobSeeker?.cv ? (
            <Group gap="md">
              <Tooltip label="Download CV" withArrow position="bottom">
                <ActionIcon
                  variant="light"
                  size="lg"
                  onClick={() => {
              ...
              <Tooltip label="Preview CV" withArrow position="bottom">
                <Group
                  gap="xs"
      ...
      >
        <Stack gap="md">
          <FileButton onChange={handleFileSelect} accept="application/pdf">
            {(props) => (
              <Button
                {...props}
                variant="light"
