...
import { useDeleteEducation, type Education } from "app/_api/profile/queries";
  ...
  return (
    <>
      ...
      >
        <Stack gap="sm">
          <Text size="sm">
            Are you sure you want to delete this education history? This action
            cannot be undone.
          </Text>
          <Group justify="flex-end" mt="md">
            ...
            <Button
              color="red"
              onClick={() =>
                currentEducation && handleDeleteExperience(currentEducation.id)
              }
