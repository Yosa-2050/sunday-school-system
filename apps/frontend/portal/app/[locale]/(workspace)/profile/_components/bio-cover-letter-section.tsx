    ...
    <Stack gap="md">
      ...
      <Paper p="md" withBorder>
        <Stack gap="md">
          ...
          <form onSubmit={coverLetterForm.onSubmit(handleCoverLetterSubmit)}>
            <Stack gap="md">
              <Textarea
                placeholder="Write your cover letter"
                minRows={6}
                {...coverLetterForm.getInputProps("coverLetter")}
              />
              <Group justify="flex-end">
                <Button type="submit" loading={isUpdatingCoverLetter}>
                  Save Cover Letter
                </Button>
              </Group>
            </Stack>
