            ...
            {(styles) => (
              <Flex>
                ...
                >
                  ...
                  <AboutSection
                    // biome-ignore lint/suspicious/noExplicitAny: <explanation>
                    data={{ bio: displayData.bio || "" } as any}
                    onUpdate={(data) => handleUpdateSection("bio", data.bio)}
                  />

                  <ExperienceSection
                    experiences={displayData.experiance}
                    onUpdate={(data) => handleUpdateSection("experiance", data)}
                  />

                  <EducationSection
                    education={displayData.educationalHistory}
                  />
