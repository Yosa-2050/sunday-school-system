            ...
            <Paper shadow="sm" p="xl" radius="md">
                <Stack gap="xl">
                    ...
                    <Stack gap="md">
                        ...
                        <List spacing="sm" size="sm" type="unordered" pl={20}>
                            <List.Item>
                                <Text component="span" fw={600}>
                                    To Provide Services:
                                </Text>
                                <List spacing="xs" size="sm" mt="xs" pl={20}>
                                    ...
                                    <List.Item>
                                        Help Employers/mentors find qualified
                                        applicants.
                                    </List.Item>
                                    <List.Item>
                            ...
                            <List.Item>
                                ...
                                <List spacing="xs" size="sm" mt="xs" pl={20}>
                                    <List.Item>
                                        Send job alerts, application updates,
                                        and promotional offers (you can opt
                                        out).
                                    </List.Item>
                                    <List.Item>
                    ...
                    <Stack gap="md">
                        ...
                        <List spacing="sm" size="sm" pl={20}>
                            <List.Item>
                                ...
                                <List spacing="xs" size="sm" mt="xs" pl={20}>
                                    <List.Item>
                                        Candidate profiles and applications are
                                        visible to Employers for recruitment
                                        purposes.
                                    </List.Item>
                                    <List.Item>
                                        Employers must use this data only for
                            ...
                            <List.Item>
                                ...
                                <List spacing="xs" size="sm" mt="xs" pl={20}>
                                    <List.Item>If required by law.</List.Item>
                                    <List.Item>
                                        To protect our rights, safety, or the
                                        safety of others.
                                    </List.Item>
                                </List>
                            </List.Item>
                    ...
                    <Stack gap="md">
                        ...
                        <List spacing="sm" size="sm" pl={20}>
                            <List.Item>
                                ...
                                Candidates can enable &quot;Private Mode&quot;
                                to restrict profile access.
                            </List.Item>
                            <List.Item>
                                <Text component="span" fw={600}>
                                    Opt-Out of Marketing:
                                </Text>{' '}
                                Unsubscribe from promotional emails via the link
                                in each message.
                            </List.Item>
                            <List.Item>
                                <Text component="span" fw={600}>
                                ...
                                Request to view, update, or delete your data by
                                contacting{' '}
                                <Anchor
                    ...
                    <Stack gap="md">
                        ...
                        <List spacing="sm" size="sm" pl={20}>
                            ...
                            <List.Item>
                                You can disable cookies in browser settings, but
                    ...
                    <Stack gap="md">
                        ...
                        <List spacing="sm" size="sm" pl={20}>
                            ...
                            <List.Item>
                                No system is 100% secure, so we cannot guarantee
                                absolute security.
                            </List.Item>
                        </List>
                    </Stack>
                    ...
                    <Stack gap="md">
                        ...
                        <List spacing="sm" size="sm" pl={20}>
                            <List.Item>
                                We may update this policy and will notify users
