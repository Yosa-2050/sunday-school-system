          ...
          <Card className="w-full">
            <Group justify={"space-between"}>
              <Stack gap="xs">
                ...
                <Group>
                  <Badge color={getStatusColor(applicationStatus)}>
              ...
              <Stack gap="xs" w={200}>
                <Group justify={"space-between"}>
                  ...
                  <Text size="sm">{applicationProgress}%</Text>
                </Group>
                <Progress value={applicationProgress} size="sm" />
              </Stack>
            </Group>
          </Card>
              ...
              <Tabs.Panel value="overview" pt="md">
                <Stack gap="md">
                  <Group>
                    ...
                    />
                    <Stack gap={0}>
                      <Title order={3}>Senior Frontend Developer</Title>
                      <Group gap="xs">
                        <Group gap={4}>
                      ...
                      <Group gap="md" mt={4}>
                        <Group gap={4}>
                          ...
                          <Text size="sm" color="dimmed">
                            San Francisco, CA (Remote option)
                          </Text>
                        </Group>
                        <Group gap={4}>
                  ...
                  <Stack gap="md">
                    <Stack gap="xs">
                      ...
                      <Text color="dimmed">
                        ...
                        join our innovative team. In this role, you will work
                        closely with designers, backend developers, and product
                        managers to create exceptional user experiences.
                      </Text>
                    </Stack>
                    ...
                    <Stack gap="xs">
                      ...
                      <List size="sm" color="dimmed">
                        <List.Item>
                          Develop and maintain responsive, cross-browser
                    ...
                    <Stack gap="xs">
                      ...
                      <List size="sm" color="dimmed">
                        ...
                        <List.Item>
                          Proficiency in JavaScript, HTML5, CSS3, and React
                        </List.Item>
                        <List.Item>
                          Experience with modern frontend frameworks and
                          libraries
                        </List.Item>
                        <List.Item>
                        ...
                        <List.Item>
                          Understanding of server-side rendering and its
                          benefits
                        </List.Item>
                        <List.Item>
                    ...
                    <Stack gap="xs">
                      ...
                      <List size="sm" color="dimmed">
                        ...
                        <List.Item>401(k) matching</List.Item>
                        <List.Item>
                          Flexible working hours and remote work options
                        </List.Item>
                        <List.Item>Professional development budget</List.Item>
                        <List.Item>Unlimited PTO policy</List.Item>
                        <List.Item>Home office stipend</List.Item>
                        <List.Item>Team retreats and social events</List.Item>
                      </List>
                    </Stack>
                  </Stack>
                </Stack>
              ...
              <Tabs.Panel value="application" pt="md">
                <form onSubmit={handleSubmit} className="w-full">
                  <Stack gap="xl">
                    ...
                    {/* Experience */}
                    <Stack gap="sm">
                      <Title order={4}>Experience & Preferences</Title>
                      ...
                      >
                        <Stack gap="sm">
                          <Text size="sm">Willing to Relocate?</Text>
                          <Radio.Group
                            value={formData.relocate}
                            onChange={(value) =>
                              handleRadioChange("relocate", value)
                            }
                          >
                            <Stack gap="xs">
                    ...
                    <Checkbox
                      label={
                        <>
                          I agree to the terms and conditions. By applying, you
                          agree to our{" "}
                          <Anchor href="#" size="sm">
                            Privacy Policy
                          </Anchor>{" "}
            ...
            <Card>
              <Stack gap="sm">
                ...
                <Stack gap="xs">
                  ...
                  <Group justify={"space-between"}>
                    <Text size="sm">Experience Details</Text>
                    <Badge
                      color="green"
                      variant="light"
                      leftSection={<IconCheck size={12} />}
            ...
            <Card>
              <Stack gap="sm">
                ...
                <Stack gap="xs">
                  ...
                  <Text size="xs" color="dimmed">
                    Make sure your resume emphasizes your experience with React,
                ...
                <Stack gap="xs">
                  ...
                  <Text size="xs" color="dimmed">
                    Add a cover letter explaining why you&pos;re a good fit for
                ...
                <Stack gap="xs">
                  ...
                  <Text size="xs" color="dimmed">
                    If you don&pos;t hear back within 7 days, consider a polite
                    follow-up.
                  </Text>
                </Stack>
              </Stack>
