...
export function JobCard({ job }: JobCardProps) {
  ...
  return (
    <Card shadow="sm" radius="md" p={8} withBorder className="relative group">
      <Stack p={8} gap="xs">
        <Group justify="space-between" align="flex-start">
          <Group gap="sm">
            <Avatar size="md" radius="md" color="primary">
            </Avatar>
            <Box>
              <Text
                size="sm"
        ...
        <Group gap="xs" mt="xs" wrap="wrap" align='center'>
           <Group gap="xs">
          <Badge color="primary" variant="light" radius="sm" size="xs">
            {job.experianceLevel}
          </Badge>
        </Group>
          <Group gap={4}>
